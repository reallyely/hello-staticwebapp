...
function $$SETUP_STATE(hydrateRuntimeState, basePath) {
  return hydrateRuntimeState({
    ...
    "dependencyTreeRoots": [
      ...
      {
        "name": "feed",
        "reference": "workspace:workspaces/feed"
      },
      {
        "name": "module",
        "reference": "workspace:workspaces/module"
      },
      {
        "name": "shell",
        "reference": "workspace:workspaces/shell"
      }
    ],
    "enableTopLevelFallback": true,
    "ignorePatternData": "(^(?:\\.vscode\\/pnpify(?:\\/(?!\\.)(?:(?:(?!(?:^|\\/)\\.).)*?)|$))$)",
    "fallbackExclusionList": [
      ["feed", ["workspace:workspaces/feed"]],
      ["module", ["workspace:workspaces/module"]],
      ["remote-mfe", ["workspace:."]],
      ["shell", ["workspace:workspaces/shell"]]
    ],
    "fallbackPool": [
    ],
    ...
    "packageRegistryData": [
      ...
      ["feed", [
        ["workspace:workspaces/feed", {
          "packageLocation": "./workspaces/feed/",
          "packageDependencies": [
            ["feed", "workspace:workspaces/feed"]
          ],
          "linkType": "SOFT",
      ...
      ["module", [
        ["workspace:workspaces/module", {
          "packageLocation": "./workspaces/module/",
          "packageDependencies": [
            ["module", "workspace:workspaces/module"]
          ],
          "linkType": "SOFT",
      ...
      ["shell", [
        ["workspace:workspaces/shell", {
          "packageLocation": "./workspaces/shell/",
          "packageDependencies": [
            ["shell", "workspace:workspaces/shell"]
          ],
          "linkType": "SOFT",
